...
const phases = [
  {
    ...
    milestones: [
       {
        title: "Hito 0.1: Estructuración del Enrutamiento",
        icon: <FolderSync />,
        tasks: [
          { who: "bot", text: "Reestructurar las carpetas de la aplicación para eliminar el grupo de rutas '(app)', solucionando así los errores 404 y simplificando la resolución de URLs.", completed: true },
        ]
      }
    ]
  },
