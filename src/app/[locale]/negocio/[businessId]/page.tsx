...
export default async function BusinessPublicProfilePage({ params }: { params: { businessId: string } }) {
    ...
    return (
        <div className="min-h-screen bg-muted/20">
            <main className="container mx-auto p-0 sm:p-4 h-full">
                <div className="grid grid-cols-1 md:grid-cols-12 md:gap-6 h-full">
                    
                    {/* Left Column: Business Info & Review Form */}
                    <div className="md:col-span-4 lg:col-span-4 space-y-6 py-4 px-2 sm:px-0">
                        {/* Business Info Card */}
                        ...
                        {/* Review Form Card */}
                        <Card className="shadow-lg lg:sticky lg:top-4" id="review-section">
                             <CardHeader>
                     ...
                     {/* Right Column: Map */}
                     <div className="hidden md:block md:col-span-8 lg:col-span-8 h-full min-h-[calc(100vh-2rem)] md:sticky md:top-4">
                        <iframe
